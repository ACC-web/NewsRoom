...
const SiteNavLogo = () => (
    <Logo>
        <LogoSvg xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 447.8 111.1">
            ...
            <path fill="url(#a)" d="M50.7 111.1l-1.5-.6C38.5 106 22.3 99.1 10.5 76.2-.6 54.4-.6 14.3.5 11c0-.1.1-.5.5-.6C14 4 26.9 0 50.7 0c26.8 0 40.7 5.6 49.7 10.4 1.5.8.9 16.4.1 25-1.1 12-3.6 28.9-9.7 40.8-11.8 22.9-28 29.8-38.7 34.3l-1.4.6zM1.8 11.6C1 14.8.7 53.9 11.8 75.5c11.5 22.5 26.8 28.9 37.9 33.6l.9.4.9-.4c11.2-4.7 26.5-11.1 38-33.6 11.1-21.6 10.8-60.8 10-63.9C90.6 6.9 77 1.5 50.7 1.5c-23.4 0-36.1 3.8-48.9 10.1zm97.9.1zm-.2-.2z"/>
            <g>
